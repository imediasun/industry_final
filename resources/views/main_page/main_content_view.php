                            ...
                            <div class="good_cont panel">
                                ...
                                //Get first image from DB
                                     ...
                                     /*   $images=DB::table('photos')
                                        ...
                                        ?>
                                        <h5 class="name_good"><?php echo $val['original']['name'];?></h5>
                                        ...
                                        <p style="position:relative;top:10px;" class="articul mar-hor"><?php echo 'Артикул '.$val['original']['articul']?></p>
                                        
                                        <h5 style="display:block" class=""><?php
